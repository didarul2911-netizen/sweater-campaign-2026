        ...
        function getTabStyles(status, isActive) {
            if (status === 'Complete') {
                ...
                return {
                    ...
                    btnClasses: isActive 
                        ? 'bg-slate-900 text-white border-2 border-slate-900 shadow-md ring-2 ring-slate-400/40' 
                        : 'bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 text-slate-900 shadow-sm',
                    titleClass: isActive ? 'text-white' : 'text-slate-900',
