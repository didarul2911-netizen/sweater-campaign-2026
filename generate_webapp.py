...
###ZONE_OPTIONS###                        </select>
                ...
                <div id="admin-dashboard-view" class="hidden space-y-6">
                    ...
                    <div class="bg-white p-4 rounded-3xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-3">
                        ...
                        <div class="flex items-center gap-2 self-start md:self-auto">
                            ...
                            <button onclick="logoutAdmin()" class="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl transition" title="Logout">
                    ...
                    <div id="admin-cloud-settings-box" class="hidden bg-gradient-to-br from-slate-900 to-slate-800 text-white p-5 rounded-3xl border border-slate-700 shadow-xl space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                ...
                                <button onclick="saveCloudUrlSetting()" class="px-4 py-2 bg-orange-500 hover:bg-orange-400 text-slate-950 text-xs font-black rounded-xl transition whitespace-nowrap">
                                    Save URL
                                </button>
                                <button onclick="testGoogleDriveConnection()" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-black rounded-xl transition whitespace-nowrap">
                                    Test Connection
                                </button>
                            </div>
    ...
    <script>
        ...
        function deleteAllCampaignData() {
            ...
            alert("🗑️ All campaign data has been completely reset and deleted!");
        }
