        ...
        function getTabStyles(status, isActive) {
            if (status === 'Complete') {
                return {
                    badgeText: '✓ Complete',
                    btnClasses: isActive 
                        ? 'bg-emerald-600 text-white border-2 border-emerald-700 shadow-md ring-2 ring-emerald-500/30' 
                        : 'bg-emerald-50 hover:bg-emerald-100 border-2 border-emerald-300 text-emerald-950 shadow-sm',
                    titleClass: isActive ? 'text-white' : 'text-emerald-950',
                ...
                return {
                    ...
                    btnClasses: isActive 
                        ? 'bg-amber-500 text-slate-950 border-2 border-amber-600 shadow-md ring-2 ring-amber-500/30' 
                        : 'bg-amber-50 hover:bg-amber-100 border-2 border-amber-300 text-amber-950 shadow-sm',
                    titleClass: 'text-slate-950',
                    sapClass: isActive ? 'text-amber-950 font-bold' : 'text-amber-800 font-bold',
                    badgeClasses: isActive 
                        ? 'bg-slate-950 text-amber-300 font-black shadow-sm' 
                ...
                return {
                    ...
                    btnClasses: isActive 
                        ? 'bg-slate-900 text-white border-2 border-slate-950 shadow-md ring-2 ring-slate-900/30' 
                        : 'bg-white hover:bg-slate-100 border-2 border-slate-200 text-slate-900 shadow-sm',
                    titleClass: isActive ? 'text-white' : 'text-slate-900',
                    sapClass: isActive ? 'text-slate-300' : 'text-slate-500',
                    badgeClasses: isActive 
