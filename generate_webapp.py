    ...
    <script>
        ...
        function generateAndDownloadExcel(territoryList, filename) {
            ...
            territoryList.forEach(t => {
                ...
                const c1M4HasAny = Boolean(d.c1_m4_sweater || d.c1_m4_size);
                const c1M4Ok = !c1M4HasAny || Boolean(d.c1_m4_sweater && d.c1_m4_size);
                const c1Complete = c1Mandatory && c1M4Ok;
                const c1HasAny = Boolean(d.c1_doc_name || d.c1_doc_rpl || d.c1_m1_sweater || d.c1_m1_size || d.c1_m2_sweater || d.c1_m2_size || d.c1_m3_sweater || d.c1_m3_size || d.c1_m4_sweater || d.c1_m4_size);
                const c1Status = c1Complete ? "Complete" : (c1HasAny ? "In Progress" : "Not Started");
                ...
                const c2Complete = c2Doc1Ok && c2Doc2Ok && c2Doc3Ok;
                const c2HasAny = Boolean(d.c2_d1_name || d.c2_d1_rpl || d.c2_d1_sweater || d.c2_d1_size || d.c2_d2_name || d.c2_d2_rpl || d.c2_d2_sweater || d.c2_d2_size || d.c2_d3_name || d.c2_d3_rpl || d.c2_d3_sweater || d.c2_d3_size);
                const c2Status = c2Complete ? "Complete" : (c2HasAny ? "In Progress" : "Not Started");
